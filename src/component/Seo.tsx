...
export default function Seo() {
  return (
    <>
      ...
      <meta name="og:image" content={`${data.siteConfig.metaUrl}/ferry-suhandri-large2.jpg`} />
      ...
      <meta name="twitter:image" content={`${data.siteConfig.metaUrl}/ferry-suhandri-large2.jpg`} />
